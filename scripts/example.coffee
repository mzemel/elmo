...
module.exports = (robot) ->
  ...
  compliments = [
    'I like you', 'You are funny', "I'm proud of you", "You're my dog's favorite person", "You're so thoughtful",
    'Your makeup is on point', 'You have a cool pet', 'Your vocabulary is sexy',
    "That's so interesting, I never thought about it that way before", "It's always helpful talking to you",
